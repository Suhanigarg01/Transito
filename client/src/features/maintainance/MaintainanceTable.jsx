...
const MaintainanceTable = ({ records = [], onClose, onEdit, onDelete, loading = false }) => {
  return (
        ...
        <table className="min-w-full">
          ...
          <tbody className="divide-y divide-stone-100">
            {loading ? (
              ...
              <tr><td className={`${td} text-center text-stone-400`} colSpan={6}>No maintenance records</td></tr>
            ) : (
              records.map((r) => (
